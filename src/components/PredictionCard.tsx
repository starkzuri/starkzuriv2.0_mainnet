...
export function PredictionCard({
  ...
  // 🟢 TYPE-SAFE CHECK: We ignore media.type entirely and just inspect the URL string
  ...
  if (isLiveMarket) {
    try {
      ...
      console.error("Failed to parse live market config", e);
    }
  }
  ...
  return (
    ...
    >
      ...
      {/* ── Featured image / Crypto Snapshot ── */}
      <div
        style={{
          position: "relative",
          width: "100%",
          height: 150,
          overflow: "hidden",
          background: isLiveMarket ? "#0a0b0f" : "transparent",
        }}
      >
        {isLiveMarket && liveConfig ? (
          // 🟢 THE LIVE MARKET BANNER
          <div
            style={{
              width: "100%",
              height: "100%",
          ...
          >
            ...
            >
              ...
              >
                🎯 $
                {Number(liveConfig.strike).toLocaleString(undefined, {
        ...
        {/* The standard bottom shadow gradient */}
        <div
          style={{
            position: "absolute",
            inset: 0,
      ...
      <div style={{ padding: "0 16px" }}>
        ...
        >
          ...
          {/* TYPE-SAFE FIX: Replaced non-existent 'traders' with 'shares' */}
          <span>
            {formatNumber(
